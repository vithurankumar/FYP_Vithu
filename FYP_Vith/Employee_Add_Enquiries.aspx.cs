        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["UserRole"] != null && Session["Username"] != null && Session["UserRole"].ToString() == "Employee")
            {
                ...
                if (Request.QueryString["addenquiries"] != null)
                {
                    ...
                    string query = $"INSERT INTO Enquiries (Emp_id, Subject, Email, Messages, Category, Sending_to, Status) VALUES ('{empid}','{subject}','{email}','{messages}','{category}','{sendto}','Pending')";
